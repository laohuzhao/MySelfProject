...
import com.example.xitong.Netty.encoder.Header;
import com.example.xitong.Netty.encoder.Message;
...
public class EchoServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        Header header=new Header((byte)0, (byte)1, (byte)1, (byte)1, (byte)0,
                "713f17ca614361fb257dc6741332caf2",
                content.getBytes("UTF-8").length, 1);
